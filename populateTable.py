...
#     (3,"User, as a Deep Learning Specialist at VinAI, developed a neural network model that improved the accuracy of the company's image recognition software by 30%. They also wrote a technical paper on their work that was published in a top-tier AI conference.","From 2023 To 2024."),
#     (2,"User, in their role as a Machine Learning Engineer at VinAI, designed an anomaly detection system that reduced fraudulent transactions by 25%. They also optimized the company's machine learning infrastructure, reducing model training time by 40%","From 2023 To 2024."),
#     (4,"In their role as an AI Analyst at VinAI, User conducted thorough market research and data analysis that informed the company's AI strategy. Their insights led to the successful launch of three new AI products.","2020 To 2023."),
